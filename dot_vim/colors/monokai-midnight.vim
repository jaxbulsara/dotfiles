...
if &t_Co > 255
   if s:molokai_original == 1
      ...
      hi CursorLineNr ctermfg=172               cterm=none
   else
   ...
   hi MatchParen      ctermfg=16  ctermbg=172 cterm=bold
   ...
   if exists("g:rehash256") && g:rehash256 == 1
       ...
       hi CursorLineNr ctermfg=251               cterm=none
       ...
       hi Error           ctermfg=228 ctermbg=233
       ...
       hi PreProc         ctermfg=197               cterm=bold
       ...
       hi PythonStrFormat ctermfg=81
       hi PythonStrFormatting ctermfg=81
   endif
end
